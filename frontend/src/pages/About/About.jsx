            ...
            <div className="w-[full] flex-col justify-between items-start">
              ...
              >
                <p className="text-sm font-serif">
                  ...
                  mouthwatering vegan masterpieces that not only tantalize your
                  taste buds but also nourish your body and the planet. that
                  vegan cuisine can be both wholesome and utterly indulgent.
                  <br /> <br />
                  ...
                  plant-based options, Chef Chantel is your guide to a world of
                  flavor and compassion.
                  <br /> <br />
                  Follow her culinary adventures for a taste of the future, one
                  delectable plate at a time! 🌱🍽️ #VeganChefMagic
                </p>
              </motion.div>
